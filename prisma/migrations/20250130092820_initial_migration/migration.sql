-- CreateEnum
CREATE TYPE "UserRole" AS ENUM ('ADMIN', 'PROJECT_MANAGER', 'USER', 'CLIENT');
...
-- CreateEnum
CREATE TYPE "DocumentType" AS ENUM ('SPECIFICATION', 'MEETING_NOTES', 'REPORT', 'OTHER');

-- CreateEnum
CREATE TYPE "TemplateType" AS ENUM ('PROJECT', 'DOCUMENT', 'MEETING', 'WORKFLOW');
